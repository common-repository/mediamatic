...
Plugin URI: https://frenify.net/envato/themedo/plugin/mediamatic/1/
Donate link: https://frenify.net/envato/themedo/plugin/mediamatic/1/
...
Manage thousands of media files and folders in your WordPress media library swiftly and smoothly! A breakthrough in WordPress media library management and organization. We don't set any limit ("FileBird", "Folders" have limits) to number of folders. 

[TEST DRIVE](https://frenify.net/envato/themedo/plugin/mediamatic/1/wp-admin/upload.php)
...
Download this plugin today for free and organize your WP media content. Then unlock more features with the <a href="https://frenify.net/envato/themedo/plugin/mediamatic/1/" target="_blank" title="PRO version">PRO version</a> for max organization! 
...
If you have a large files and want to use more features, you can upgrade to <a href="https://frenify.net/envato/themedo/plugin/mediamatic/1/" target="_blank" title="PRO version">PRO version</a>


== Changelog ==

= 2.7 - October 01, 2021 = 
- Fixed: Select issue has been fixed. (It was related with escape function)

= 2.6 - September 29, 2021 = 
- Fixed: All inputs/outputs are sanitized and escaped properly.

= 2.5 - February 02, 2021 = 
- Changed: Limit is removed from folders count
